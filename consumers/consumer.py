...
class KafkaConsumer:
    ...
    def __init__(
        ...
        if is_avro is True:
            ...
            self.consumer = AvroConsumer({"bootstrap.servers": BROKER_URL, "group.id": "0", "schema.registry.url": SCHEMA_REGISTRY_URL})
        else:
            #self.consumer = Consumer(...)
            self.consumer = Consumer({"bootstrap.servers": BROKER_URL, "group.id": "0"})
